                    ...
                    <div class="row">
                        <?php foreach ($upload_data as $item => $value):?>
                            <?php if ($item == 'file_name'):?>
                                <div class="col-lg-6 d-none d-lg-block" style="background:url(<?php echo base_url()?>assets/uploads/<?php echo $value?>);background-position:center;background-size:cover">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <h4 class="text-gray-900 mb-4">Masuk</h4>
                                </div>
