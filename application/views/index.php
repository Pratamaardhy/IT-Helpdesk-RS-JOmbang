...
<head>
    <meta charset="utf-8" />
    <title>Helpdesk RSUD Jombang</title>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?= base_url() ?>assets/landing/images/logo-rsud.png">
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="58" class="scrollspy-example">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark" id="nav-sticky">
        <div class="container-fluid">
            ...
            <a class="logo text-uppercase" href="<?= base_url() ?>">
                <img src="<?= base_url() ?>assets/landing/images/logo-rsud-jombang.png" alt="" class="logo-light" height="54" />
                <img src="<?= base_url() ?>assets/landing/images/logo-rsud-jombang.png" alt="" class="logo-dark" height="54" />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto" id="mySidenav">
                    ...
                    <li class="nav-item">
                        <a href="<?= site_url('login') ?>" class="nav-link text-danger">Login</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6">
                            <div class="home-title">
                                <h5 class="mb-3 text-white-50">SELAMAT DATANG DI RSUD JOMBANG</h5>
                                <h2 class="mb-4 text-white">Rumah Sakit Umum Daerah Kabupaten Jombang</h2>
                                <p class="text-white-50 home-desc font-16 mb-5">Menjadi Rumah Sakit Rujukan Terdepan Pilihan Utama Masyarakat Dengan Layanan Paripurna Melalui Sistem Pendidikan Kesehatan Terintegrasi </p>
                        ...
                        <div class="col-lg-5 offset-lg-1 col-sm-6">
                            <div class="home-img mo-mt-20">
                                <img src="<?= base_url() ?>assets/landing/images/rsud_jombang.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-customize-tab" data-bs-toggle="pill" href="#pills-customize" role="tab" aria-controls="pills-customize" aria-selected="false">
                                <div class="clearfix">
                                    ...
                                    <div class="d-none d-lg-block me-4">
                                        <h5 class="tab-title">EMERGENCY CALL 119</h5>
                                        <p>Tim Emergency 119 RSUD Jombang</p>
                                    </div>
                                </div>
                            </a>
                        </li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title text-center">
                        ...
                        <p class="text-muted">Perawatan & Pelayanan Berkualitas</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        <div class="services-img float-start me-4">
                            <img src="<?= base_url() ?>assets/landing/images/icons/layers.png" alt="">
                        </div>
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi Rawat Jalan</h5>
                ...
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        ...
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi Rawat Inap</h5>
                ...
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        ...
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi Gawat Darurat</h5>
                ...
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        ...
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi Laboratorium Klinik</h5>
                ...
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        ...
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi Laboratorium Patologi Anatomi</h5>
                ...
                <div class="col-xl-4 col-sm-6 mb-4">
                    <div class="services-box h-100 p-4 bg-white mt-4">
                        ...
                        <div class="overflow-hidden">
                            <h5 class="pb-2">Instalasi ICU Sentral</h5>
    ...
    <section class="section bg-light" id="clients">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="testi-box h-100 p-4 bg-white mt-4 text-center">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center p-3">
                        ...
                        <div class="counter-content">
                            ...
                            <h5 class="counter-name text-white">Pasien Ditangani</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
