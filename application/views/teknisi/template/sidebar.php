        ...
        <div class="sidebar-brand-text">Helpdesk RSUD Jombang</div>
    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= site_url('teknisi/dashboard/tiket_selesai') ?>">Tiket Selesai</a>
                        <a class="collapse-item" href="<?= site_url('teknisi/dashboard/daftartiket') ?>">Daftar Tiket</a>
                    </div>
                </div>
            </li>
